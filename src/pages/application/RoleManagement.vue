      ...
      <q-card>
        <q-card-section class="bg-amber-7">
          <div class="text-h6">
            ...
            <span class="card-header-label"> Role Management </span>
          </div>
          <div
...
<script>
import { ref } from "vue";
import { ROLE_MANAGEMENT_TABLE_COLUMNS } from "src/utils/table-columns/role-management-table";
...
export default {
  data: () => ({
    ...
    tblMoCols: [...ROLE_MANAGEMENT_TABLE_COLUMNS],
  ...
  methods: {
    ...
    onCreatePod() {
      this.viewModal = "Create New Role";
