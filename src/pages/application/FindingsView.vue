      ...
      <q-card>
        <q-card-section class="bg-amber-7">
          <div class="text-h6">
            ...
            <span class="card-header-label"> Findings And Recommendation </span>
          </div>
          <div
...
<script>
import { ref } from "vue";
import { FINDINGS_TABLE_COLUMNS } from "src/utils/table-columns/findings-table";
...
export default {
  data: () => ({
    ...
    tblMoCols: [...FINDINGS_TABLE_COLUMNS],
  ...
  methods: {
    ...
    onCreatePod() {
      this.viewModal = "Create New Findings";
      this.showAddPodDialog = true;
    },
    onSelectItem() {
      // this.viewModal = "Update Role";
      // this.showAddPodDialog = true;
      this.$router.push({ name: "recom-view" });
    },
  },
