      ...
      <q-card>
        <q-card-section class="bg-amber-7">
          <div class="text-h6">
            ...
            <span class="card-header-label"> Facility Management </span>
          </div>
          <div
          ...
          <q-card-section class="q-pt-none">
            <div class="row q-col-gutter-md">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-input outlined dense v-model="facility.code" label="Code" />
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-input
                  outlined
...
<script>
import { ref } from "vue";
import { FACILITY_TABLE_COLUMNS } from "src/utils/table-columns/facility-table";
...
export default {
  data: () => ({
    ...
    tblMoCols: [...FACILITY_TABLE_COLUMNS],
  ...
  methods: {
    ...
    onCreatePod() {
      this.facility = {};
      this.viewModal = "Create New Facility";
      this.showAddPodDialog = true;
    },
    onSelectItem() {
      this.facility = { facility: "sample", code: "sample" };
      this.viewModal = "Update Facility";
      this.showAddPodDialog = true;
    },
  },
