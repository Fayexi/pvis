      ...
      <q-card>
        <q-card-section class="bg-amber-7">
          <div class="text-h6">
            ...
            <span class="card-header-label"> Group Management </span>
          </div>
          <div
...
<script>
import { ref } from "vue";
import { GROUP_MANAGEMENT_TABLE_COLUMNS } from "src/utils/table-columns/group-management-table";
...
export default {
  data: () => ({
    ...
    tblMoCols: [...GROUP_MANAGEMENT_TABLE_COLUMNS],
  ...
  methods: {
    ...
    onCreatePod() {
      this.viewModal = "Add New Group Management";
      this.showAddPodDialog = true;
    },
    onSelectItem() {
      this.viewModal = "Update Group Management";
      this.showAddPodDialog = true;
    },
  },
